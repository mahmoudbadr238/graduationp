"""
Regression tests for backend.engines.scanning.report_schema v2.0 helpers.
...
# ── import under test ─────────────────────────────────────────────────────────
_schema = importlib.import_module("backend.engines.scanning.report_schema")
...
class TestNormalizeReportV2(unittest.TestCase):
    ...
    _ARRAY_KEYS = {
        "static": ["engines", "top_strings", "suspicious_imports"],
        "sandbox": [
            "processes_started",
            "files_created",
            "files_modified",
    ...
    def test_fills_missing_static_engines(self) -> None:
        ...
        self.assertIsInstance(out["static"]["groq_analysis"], dict)
