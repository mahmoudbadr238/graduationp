...
class SandboxController:
    ...
    def __init__(self) -> None:
        from backend.engines.sandbox_vmware.config import load_sandbox_config
        from backend.engines.sandbox_vmware.vmrun_client import VmrunClient
    ...
    def _run_in_vmware(
        ...
        from backend.engines.sandbox_vmware.vmrun_client import VmrunError
